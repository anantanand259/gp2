...
log.info('⏳ Loading BAAI/bge-m3 embedding model (first run ~2-3 min)...')
...
- If context lacks the answer, say: "This specific information is not available in our knowledge base. Please contact the college directly or visit gpa.ac.in."
- Keep answers concise, factual, and well-formatted with markdown.
- Preserve Hindi text as-is. Do NOT hallucinate dates, numbers, or names.
- Use bullet points and bold text for readability.
- If the user asks a general question (math, science, etc.), answer it using your own knowledge.
'''
...
def trigger_ingest():
    """Re-scan input_docs/ and process new files."""
    global hybrid_retriever
    try:
